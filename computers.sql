...
--
-- Host: localhost
-- Generation Time: Jun 21, 2018 at 03:04 PM
...
(10, '2018-06-20', 5, 'Mouse not working', 1, 'pankajjjjjj', 'fixed', 'Krish'),
(11, '2018-06-20', 5, 'Mouse not working', 1, 'Pankaj', NULL, 'Krish'),
(12, '2018-06-20', 5, 'Ram', 1, 'Pankaj', NULL, 'Krish');
...
(5, '1010', 'i3', '4 GB', '1 TB', '2018-06-08', 13000, 'INACTIVE');
...
(11, 5, '2018-06-20', '2018-06-28', 'Display changed', 2000),
(12, 5, '2018-06-20', '2018-06-28', 'fixed', 800),
(13, 5, '2033-12-24', '0000-00-00', NULL, NULL);
...
--
ALTER TABLE `complaint_book`
  MODIFY `complaint_book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `repair_history`
  MODIFY `repair_history_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
